    ...
    <div>
      <div className="px-4 py-2 grid grid-cols-3 text-center gap-8">
        {navigationData.map(el => (
          <Link key={el.route} href={el.route}>{el.text}</Link>
        ))}
      </div>
        ...
        {isOpen && (
          <div>
            ...
            <ol>
              ...
              <ol>
                <li><Link href="https://pagespeed.web.dev/analysis/https-image-comparison-vercel-app-next-image/0u4d1wakd2?form_factor=mobile" target="_blank" className="text-sky-400">Next Image</Link></li>
                <li><Link href="https://pagespeed.web.dev/analysis/https-image-comparison-vercel-app-image-tag/mm7u1wah3s?form_factor=mobile" target="_blank" className="text-sky-400">Image Tags</Link></li>
              </ol>
